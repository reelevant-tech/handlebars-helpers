...
test('map: should display map', (t) => {
  ...
  t.equal(result, '<img src="https://maps.googleapis.com/maps/api/staticmap?markers=color%3A%7C10%2C-12&size=320x270&key=KEY&signature=xKaYXuO17n4U9BQgz4h-00toqr4&zoom=10" width="320" />')
  t.end()
})
